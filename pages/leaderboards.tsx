		...
		return (
			<div className="space-y-2">
				{selections.map((name, index) => {
					...
					let className =
						"py-1 rounded px-2 flex items-center justify-between";
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						<div className="bg-gray-50 p-4 rounded-lg">
							...
							<ol className="space-y-3">
								{["menFirst", "menSecond", "menThird"].map(
									(pos, index) => {
										const lifterInfo = getLifterInfo(
											results[
												pos as keyof CompetitionResult
											] as string
										);
										return (
											<li
						...
						<div className="bg-gray-50 p-4 rounded-lg">
							...
							<div className="flex flex-wrap gap-4">
								...
								<div className="flex items-center">
									...
									<span>
										Right lifter, wrong position (1-2
										points)
									</span>
								</div>
							</div>
